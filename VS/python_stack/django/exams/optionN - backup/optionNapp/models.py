...
class PostManager(models.Manager):
    def thought_validate(self, form):
        errors = {}
        if len(form['thought']) < 5:
            errors['thought'] = 'Thoughts must be at least 10 characters'
        return errors


class Post(models.Model):
    thought = models.TextField(max_length=255)
    poster = models.ForeignKey(User, related_name="has_created_thought", on_delete=models.CASCADE)
    liked_by = models.ManyToManyField(User, related_name='liked_thoughts')
